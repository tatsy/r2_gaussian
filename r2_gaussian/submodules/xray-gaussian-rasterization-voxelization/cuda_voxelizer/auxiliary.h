...
__forceinline__ __device__ void getCube(const float3 p,
                                        float3 max_radius,
                                        uint3 &cube_min,
                                        uint3 &cube_max,
                                        dim3 grid) {
    cube_min = { min(grid.x, max((int)0, (int)((p.x - max_radius.x) / BLOCK3D_X))),
                 min(grid.y, max((int)0, (int)((p.y - max_radius.y) / BLOCK3D_Y))),
                 min(grid.z, max((int)0, (int)((p.z - max_radius.z) / BLOCK3D_Z))) };
    cube_max = { min(grid.x, max((int)0, (int)((p.x + max_radius.x + BLOCK3D_X - 1) / BLOCK3D_X))),
