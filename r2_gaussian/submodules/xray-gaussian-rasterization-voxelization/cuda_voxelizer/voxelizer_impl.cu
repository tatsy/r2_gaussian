...
static __global__ void duplicateWithKeys(int P,
...
int CudaVoxelizer::Voxelizer::forward(std::function<char *(size_t)> geometryBuffer,
    ...
    dim3 tile_grid((nVoxel_x + BLOCK3D_X - 1) / BLOCK3D_X,
                   (nVoxel_y + BLOCK3D_Y - 1) / BLOCK3D_Y,
                   (nVoxel_z + BLOCK3D_Z - 1) / BLOCK3D_Z);
...
void CudaVoxelizer::Voxelizer::backward(const int P,
                                        int R,
                                        const int nVoxel_x,
                                        int nVoxel_y,
                                        int nVoxel_z,
